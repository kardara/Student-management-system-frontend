...
export default function StudentDashboard() {
    ...
    useEffect(() => {
        manageStudentRegistrationService.getStudent(context.user.id).then((resp) => {
            console.log(resp);
    ...
    const transformCourseData = (registrations) => {
        ...
        return registrations.courses.map(courseReg => ({
            ...
            day: courseReg.day.charAt(0).toUpperCase() + courseReg.day.slice(1).toLowerCase(),
    ...
    const headers = ["Course Code", "Course Name", "Day", "Time", "Teacher", "Credits"];
    const courseData = transformCourseData(registrations);

    // Calculate total credits
    const totalCredits = registrations?.courses?.reduce((total, course) => total + course.course.credit, 0) || 0;
            ...
            <div className="max-w-7xl mx-auto space-y-8">
                    ...
                    <div className="bg-bg-secondary-light dark:bg-bg-secondary-dark rounded-2xl shadow-lg p-6 border border-border-light dark:border-border-dark">
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="font-bold text-lg">{registrations.student.department.name}</p>
                            </div>
                            <div className="space-y-2">
                        ...
                        <div className="bg-bg-secondary-light dark:bg-bg-secondary-dark rounded-2xl shadow-lg p-6 border border-border-light dark:border-border-dark">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="font-bold text-lg">{registrations.semester.name} {registrations.semester.year}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-bg-secondary-light dark:bg-bg-secondary-dark rounded-2xl shadow-lg p-6 border border-border-light dark:border-border-dark">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="font-bold text-lg text-accent-light dark:text-accent-dark">{totalCredits}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-bg-secondary-light dark:bg-bg-secondary-dark rounded-2xl shadow-lg p-6 border border-border-light dark:border-border-dark">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="font-bold text-lg text-accent-light dark:text-accent-dark">{courseData.length}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="bg-bg-secondary-light dark:bg-bg-secondary-dark rounded-2xl shadow-lg p-6 border border-border-light dark:border-border-dark">
                    ...
                    {courseData.length > 0 ? (
                            ...
                            <table className="w-full">
                                ...
                                <tbody>
                                    {courseData.map((course, index) => (
                                        <tr key={index} className="border-t border-border-light dark:border-border-dark hover:bg-bg-light dark:hover:bg-bg-dark transition-colors duration-200">
                                            ...
                                            <td className="px-6 py-4">
                                                <div>
                                                    ...
                                                    <p className="text-sm text-gray-500">Group {course.group} • Room {course.room}</p>
                                                </div>
                                            </td>
                                            <td className="px-6 py-4">
                        ...
                        <div className="text-center py-12">
                            ...
                            <h3 className="text-lg font-medium text-gray-500">No courses registered</h3>
                            <p className="text-gray-400 mt-2">You haven't registered for any courses yet.</p>
                        </div>
                    )}
                </div>
                ...
                <div className="bg-bg-secondary-light dark:bg-bg-secondary-dark rounded-2xl shadow-lg p-6 border border-border-light dark:border-border-dark">
                    ...
                    <div className="space-y-4">
                        {announcements.map((announcement, index) => (
                            <div key={index} className="bg-bg-light dark:bg-bg-dark rounded-xl p-6 border border-border-light dark:border-border-dark hover:shadow-md transition-all duration-200">
                ...
                <div className="bg-bg-secondary-light dark:bg-bg-secondary-dark rounded-2xl shadow-lg p-6 border border-border-light dark:border-border-dark">
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                        <button className="p-4 bg-button-bg-primary-light dark:bg-primary-dark text-button-text-primary-dark rounded-xl font-semibold hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl">
                            View Grades
                        </button>
                        <button className="p-4 bg-button-bg-primary-light dark:bg-primary-dark text-button-text-primary-dark rounded-xl font-semibold hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl">
                            Download Schedule
