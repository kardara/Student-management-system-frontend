          ...
          <div className="bg-bg-secondary-light dark:bg-bg-secondary-dark rounded-2xl shadow-lg border border-border-light dark:border-border-dark overflow-hidden">
            <div className="p-8 text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-error-light/10 dark:bg-error-dark/10 rounded-full mb-4">
                <svg
                  className="w-8 h-8 text-error-light dark:text-error-dark"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <h2 className="text-2xl font-bold text-error-light dark:text-error-dark mb-2">
                Student Not Found
              </h2>
            ...
            <div className="p-6 border-b border-border-light dark:border-border-dark">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-accent-light/10 dark:bg-accent-dark/10 rounded-lg">
                  <svg
                    className="w-5 h-5 text-accent-light dark:text-accent-dark"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
          ...
          <div className="space-y-8">
              ...
              <div className="p-6 border-b border-border-light dark:border-border-dark">
                <div className="flex items-center gap-3">
                  <div className="p-2 bg-success-light/10 dark:bg-success-dark/10 rounded-lg">
                    <svg
                      className="w-5 h-5 text-success-light dark:text-success-dark"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                ...
                <p className="text-text-secondary-light dark:text-text-secondary-dark mt-2 text-sm">
                  Manage academic details and enrollment
                </p>
              </div>
            ...
            <div className="bg-bg-secondary-light dark:bg-bg-secondary-dark rounded-2xl shadow-lg border border-border-light dark:border-border-dark overflow-hidden">
              <div className="p-6 border-b border-border-light dark:border-border-dark">
                ...
                <p className="text-text-secondary-light dark:text-text-secondary-dark mt-2 text-sm">
                  Reset student password if needed
                </p>
              </div>
              ...
              <div className="p-6">
                <div className="bg-primary-light/5 dark:bg-primary-dark/5 border border-primary-light/20 dark:border-primary-dark/20 rounded-xl p-4 mb-4">
                  <div className="flex items-start gap-3">
                    <svg
                      className="w-5 h-5 text-primary-light dark:text-primary-dark mt-0.5 flex-shrink-0"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
